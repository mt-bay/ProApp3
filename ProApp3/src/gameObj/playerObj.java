...
public class playerObj extends charObj{
	 ...
	 */
	public playerObj(){
		set(new rect(), new point(), 0.0d, Direction.RIGHT, false, true, false, -1, new Input[num_prev]);
	}
	...
	private void set(rect _rect, point _accel, double _hp, Direction _dir, boolean _isGnd, boolean _isGravitied, boolean _isShooting, int _t_deform, Input[] _ip_prev){
