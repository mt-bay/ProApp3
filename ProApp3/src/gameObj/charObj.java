...
public class charObj extends rect {
	 ...
	 * 引数：それぞれのデータ
	 */
	public charObj(rect _rect, point _accel, double _hp, Direction _dir, boolean _isGnd, boolean _isGravitied){
	 ...
	 * 引数：それぞれのデータ
	 */
	protected void set(rect _rect, point _accel, double _hp, Direction _dir, boolean _isGnd, boolean _isGravitied){
		accel       = _accel;
		hp          = _hp;
		dir         = _dir;
		isGnd       = _isGnd;
